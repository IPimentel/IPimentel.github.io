...
let filtro = document.querySelector(`.criterio`)
let busqueda = document.querySelector(`.buscador`)
let btn_filtro = document.querySelector(`.btn`)
...
function detectarEnter(e) {
  if(e.key == `Enter`){
    if(busqueda){
      ...
      `
      cargar(`https://rickandmortyapi.com/api/character/?${filtro.value}=${busqueda.value}`)  
    }
  }
}
